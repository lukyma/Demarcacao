...
using web.api.demarcacao.gestao.empreendimento.Endpoint.Config.Swagger.Security;
using web.api.demarcacao.gestao.empreendimento.Endpoint.Helpers.AuthHandler;
using web.api.demarcacao.gestao.empreendimento.Endpoint.Helpers.AuthHandler.Requirement;
using web.api.demarcacao.gestao.empreendimento.Endpoint.Helpers.Middleware;
using web.api.demarcacao.gestao.empreendimento.Endpoint.Models.Automapper;
using web.api.demarcacao.gestao.empreendimento.Endpoint.Models.HandleValidaiton;
using web.api.demarcacao.gestao.empreendimento.IoC;
using web.api.demarcacao.gestao.empreendimento.Service.Automapper;

namespace web.api.demarcacao.gestao.empreendimento.Endpoint
{
    /// <summary>
    /// Classe startup
    /// </summary>
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.InstanceName = "GestaoEmpreendimento-";
                options.Configuration = Environment.GetEnvironmentVariable("RedisConnection");
            });

            services.RegisterDependencies<IDemarcacaoGestaoEmpreendimentoPostgressContext, DemarcacaoGestaoEmpreendimentoPostgressContext>(Configuration);

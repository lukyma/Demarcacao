...
using static web.api.demarcacao.gestao.terreno.Endpoint.Config.Swagger.SwaggerErrorMessages;

namespace web.api.demarcacao.gestao.terreno.Endpoint.Config.Swagger
{
